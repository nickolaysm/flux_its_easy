...
},{"./lib/addons/FluxComponent":5}],2:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":13,"uniqueid":12}],3:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./Actions":2,"./Store":4,"_process":13,"eventemitter3":7,"flux":8,"object-assign":11}],4:[function(require,module,exports){
'use strict';
...
},{"eventemitter3":7,"object-assign":11}],5:[function(require,module,exports){
'use strict';
...
},{"./reactComponentMethods":6,"object-assign":11,"react/addons":14}],6:[function(require,module,exports){
'use strict';
...
},{"../Flux":3,"object-assign":11,"react":186}],7:[function(require,module,exports){
'use strict';
...
},{"./emptyFunction":143,"_process":13}],186:[function(require,module,exports){
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var o=0;o<t.length;o++){var n=t[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,o,n){return o&&e(t.prototype,o),n&&e(t,n),t}}(),_flummox=require("flummox"),_underscore=require("underscore"),_underscore2=_interopRequireDefault(_underscore),ActionEmployee=function(e){function t(){_classCallCheck(this,t),null!=e&&e.apply(this,arguments)}return _inherits(t,e),_createClass(t,[{key:"filter",value:function(e){return console.log("filter"),this.loadEmployees(e)}},{key:"loadEmployee",value:function(e){return this.loadEmployees({uuid:e})}},{key:"saveEmployee",value:function(e){return this.saveEmployeeInner(e)}},{key:"loadEmployees",value:function(e){var t=this;return new Promise(function(o,n){setTimeout(function(){o(t.httpRequest_getEmployees(e))},1e3)})}},{key:"saveEmployeeInner",value:function(e){var t=this;return new Promise(function(o,n){setTimeout(function(){o(t.httpRequest_saveEmployees(e))},1e3)})}},{key:"httpRequest_saveEmployees",value:function(e){var t=this.httpRequest_getEmployees();t.forEach(function(t,o,n){(t.uuid=e.uuid)&&_underscore2["default"].extend(t,e)})}},{key:"httpRequest_getEmployees",value:function(e){var t=[{uuid:"00000001",email:"ivanov@mail.net",name:"Иван",secname:"Иванов",middlename:"Иванович",org:"Детский сад №1",position:"Директор",snils:"000-000-000 1"},{uuid:"00000002",email:"petrov@mail.net",name:"Петр",secname:"Петров",middlename:"Петрович",org:"Детский сад №2",position:"Глав. бух",snils:"000-000-000 2"},{uuid:"00000003",email:"sidorov@mail.net",name:"Сидр",secname:"Сидоров",middlename:"Сидорович",org:"Детский сад №3",position:"Главный помощник младшей уборщицы",snils:"000-000-000 3"}];return e?t.filter(function(t){var o=!1;return e.id?e.uuid==t.uuid:(""==e.text&&(o=!0),e.text&&(o=o||t.name.toLowerCase().indexOf(e.text.toLowerCase())>-1||t.secname.toLowerCase().indexOf(e.text.toLowerCase())>-1||t.middlename.toLowerCase().indexOf(e.text.toLowerCase())>-1||t.org.toLowerCase().indexOf(e.text.toLowerCase())>-1||t.position.toLowerCase().indexOf(e.text.toLowerCase())>-1||t.email.toLowerCase().indexOf(e.text.toLowerCase())>-1),o)}):t}}]),t}(_flummox.Actions);exports["default"]=ActionEmployee,module.exports=exports["default"];


},{"flummox":3,"underscore":187}],189:[function(require,module,exports){
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var o=0;o<t.length;o++){var r=t[o];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,o,r){return o&&e(t.prototype,o),r&&e(t,r),t}}(),_get=function(e,t,o){for(var r=!0;r;){var l=e,n=t,i=o;a=u=s=void 0,r=!1;var a=Object.getOwnPropertyDescriptor(l,n);if(void 0!==a){if("value"in a)return a.value;var s=a.get;return void 0===s?void 0:s.call(i)}var u=Object.getPrototypeOf(l);if(null===u)return void 0;e=u,t=n,o=i,r=!0}},_flummox=require("flummox"),StoreEmployee=function(e){function t(e){_classCallCheck(this,t),_get(Object.getPrototypeOf(t.prototype),"constructor",this).call(this);var o=e.getActions("action");this.register(o.filter,this.handleFilter),this.register(o.loadEmployee,this.handleLoadEmployee),this.register(o.saveEmployee,this.handleSaveEmployee),this.state={employees:[],employee:{}}}return _inherits(t,e),_createClass(t,[{key:"handleFilter",value:function(e){console.log("handleFilter",e),this.setState({employees:e})}},{key:"handleLoadEmployee",value:function(e){this.setState({employee:e})}},{key:"handleSaveEmployee",value:function(e){this.setState({employees:e})}}]),t}(_flummox.Store);exports["default"]=StoreEmployee,module.exports=exports["default"];


},{"flummox":3}],190:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(e.__proto__=t)}var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var l=t[r];l.enumerable=l.enumerable||!1,l.configurable=!0,"value"in l&&(l.writable=!0),Object.defineProperty(e,l.key,l)}}return function(t,r,l){return r&&e(t.prototype,r),l&&e(t,l),t}}(),_react=require("react"),_react2=_interopRequireDefault(_react),_flummoxComponent=require("flummox/component"),_flummoxComponent2=_interopRequireDefault(_flummoxComponent),_appJsx=require("./app.jsx"),_appJsx2=_interopRequireDefault(_appJsx),_ViewEmployeesJsx=require("./ViewEmployees.jsx"),_ViewEmployeesJsx2=_interopRequireDefault(_ViewEmployeesJsx),_ViewEmployeeCounterJsx=require("./ViewEmployeeCounter.jsx"),_ViewEmployeeCounterJsx2=_interopRequireDefault(_ViewEmployeeCounterJsx),_ViewEmployeesFilterJsx=require("./ViewEmployeesFilter.jsx"),_ViewEmployeesFilterJsx2=_interopRequireDefault(_ViewEmployeesFilterJsx),View=function(e){function t(){_classCallCheck(this,t),null!=e&&e.apply(this,arguments)}return _inherits(t,e),_createClass(t,[{key:"render",value:function(){return _react2["default"].createElement("div",null,_react2["default"].createElement(_flummoxComponent2["default"],{flux:_appJsx2["default"],connectToStores:["store"]},_react2["default"].createElement(_ViewEmployeeCounterJsx2["default"],null)),_react2["default"].createElement(_flummoxComponent2["default"],{flux:_appJsx2["default"],connectToStores:["store"]},_react2["default"].createElement(_ViewEmployeesFilterJsx2["default"],null),_react2["default"].createElement(_ViewEmployeesJsx2["default"],null)))}}]),t}(_react2["default"].Component);window.Flux={View:View,React:_react2["default"]};


},{"./ViewEmployeeCounter.jsx":191,"./ViewEmployees.jsx":192,"./ViewEmployeesFilter.jsx":193,"./app.jsx":194,"flummox/component":1,"react":186}],191:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0});var _react=require("react"),_react2=_interopRequireDefault(_react),ViewEmployeeCounter=_react2["default"].createClass({displayName:"ViewEmployeeCounter",render:function(){return console.log("ViewEmployeeCounter"),_react2["default"].createElement("div",null,_react2["default"].createElement("span",{className:"badge"},this.props.employees.length))}});exports["default"]=ViewEmployeeCounter,module.exports=exports["default"];


},{"react":186}],192:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0});var _react=require("react"),_react2=_interopRequireDefault(_react),ViewEmployees=_react2["default"].createClass({displayName:"ViewEmployees",load:function(){this.props.flux.getActions("action").filter()},render:function(){console.log("this.props",this.props);var e=this.props.employees.map(function(e){return _react2["default"].createElement("div",{key:e.uuid},_react2["default"].createElement("div",{className:"row"},_react2["default"].createElement("div",null,e.email," ",e.middlename," ",e.name," ",e.secname),_react2["default"].createElement("div",null,e.org," ",e.position)))});return _react2["default"].createElement("div",{className:"grid"},_react2["default"].createElement("div",{onClick:this.load},_react2["default"].createElement("span",{className:"button"},"Показать Сотрудников")),_react2["default"].createElement("div",{className:"list"},e))}});exports["default"]=ViewEmployees,module.exports=exports["default"];


},{"react":186}],193:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0});var _react=require("react"),_react2=_interopRequireDefault(_react),ViewEmployeesFilter=_react2["default"].createClass({displayName:"ViewEmployeesFilter",keyPress:function(e){13==e.keyCode&&this.props.flux.getActions("action").filter({text:e.target.value})},render:function(){return console.log("ViewEmployeesFilter"),_react2["default"].createElement("div",null,_react2["default"].createElement("span",null,"Фильтр:"),_react2["default"].createElement("input",{ref:"filter",type:"text",onKeyUp:this.keyPress}))}});exports["default"]=ViewEmployeesFilter,module.exports=exports["default"];


},{"react":186}],194:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _get=function(e,t,o){for(var r=!0;r;){var n=e,i=t,u=o;l=c=a=void 0,r=!1;var l=Object.getOwnPropertyDescriptor(n,i);if(void 0!==l){if("value"in l)return l.value;var a=l.get;return void 0===a?void 0:a.call(u)}var c=Object.getPrototypeOf(n);if(null===c)return void 0;e=c,t=i,o=u,r=!0}},_react=require("react"),_react2=_interopRequireDefault(_react),_flummox=require("flummox"),_flummoxComponent=require("flummox/component"),_flummoxComponent2=_interopRequireDefault(_flummoxComponent),_ActionJsx=require("./Action.jsx"),_ActionJsx2=_interopRequireDefault(_ActionJsx),_StoreJsx=require("./Store.jsx"),_StoreJsx2=_interopRequireDefault(_StoreJsx),ApplicationFlux=function(e){function t(){_classCallCheck(this,t),_get(Object.getPrototypeOf(t.prototype),"constructor",this).call(this),this.createActions("action",_ActionJsx2["default"]),this.createStore("store",_StoreJsx2["default"],this)}return _inherits(t,e),t}(_flummox.Flux),flux=new ApplicationFlux;exports["default"]=flux,module.exports=exports["default"];


},{"./Action.jsx":188,"./Store.jsx":189,"flummox":3,"flummox/component":1,"react":186}]},{},[188,189,190,191,192,193,194]);
